...
void LoginDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(LOGIN_SEL_MAC_INFO, "SELECT account_id, username, mac FROM mac_addresses WHERE mac = ?", CONNECTION_SYNCH);
    ...
    PrepareStatement(LOGIN_INS_MAC_BANNED, "INSERT INTO mac_banned VALUES (?, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()+?, ?, ?)", CONNECTION_ASYNC);
